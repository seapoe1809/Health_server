document.addEventListener('DOMContentLoaded', function() {
    const appInfo = {
        App_name: 'Strep_Module',  // Replace with the actual app name
        app_folder: 'Strep_Module'       // Replace with the actual image folder
    };

    // Get the install link element"""WILL be in static folder, linking to install.html and subsequently to install_module"
    const installLink = document.getElementById('Strep_Module-link');
